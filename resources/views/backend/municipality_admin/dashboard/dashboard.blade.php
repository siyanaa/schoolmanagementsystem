        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="holidayEndDate" placeholder="Leave empty if only one day">
                </div>
...
$('#saveHolidayRange').click(function() {
    ...
    var endDate = $('#holidayEndDate').val(); // This can be empty
    ...
    if (confirm(message)) {
        $.ajax({
            ...
            data: {
                ...
                end_date: endDate, // Send even if empty
                reason: reason,
                context: context
            },
            success: function(response) {
